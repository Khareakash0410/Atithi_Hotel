  ...
  return (
    <div className="px-7 py-6">
      <h3>
        ...
        {discount ? (
            <span className="font-bold text-xl">{" "}| discount {discount}%. Now <span className="text-tertiary-dark">₹ {discountPrice}</span></span>) : 
            ("")
        }
      </h3>
      ...
      <button type="button" onClick={handleBookNow} disabled={isBooked} className="btn-primary w-full mt-6 disabled:bg-gray-500 disabled:cursor-not-allowed">
